...
**
** Created: Wed Mar 22 16:26:07 2017
...
static const char qt_meta_stringdata_MyView[] = {
    "MyView\0\0signal_scale(float)\0"
};
...
void MyView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signal_scale((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void MyView::signal_scale(float _t1)
{
